...
$moneda="978";
$trans="0";
$url="https://app.phonealo.net/payment/init";
$urlOK="https://app.phonealo.net/payment/done?process=".$secure_pay_id.'1';
$urlKO="https://app.phonealo.net/payment/fail?failed=".$secure_pay_id.'0';
//$id=time();
