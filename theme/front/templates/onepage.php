...
<head>
    <meta charset="utf-8">
    <title>CALL 53 - LLamadas a Cuba - Alta calidad a bajos precios</title>
    ...
    <!-- Fonts END -->
    <!-- Global styles BEGIN -->
    <link href="<?=base_path;?>theme/assets/global/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?=base_path;?>theme/assets/global/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet">
    <link href="<?=base_path;?>theme/assets/global/plugins/slider-revolution-slider/rs-plugin/css/settings.css" rel="stylesheet">
    <!-- Global styles END -->
    <!-- Page level plugin styles BEGIN -->
    <link href="<?=base_path;?>theme/assets/global/plugins/fancybox/source/jquery.fancybox.css" rel="stylesheet">
    <!-- Page level plugin styles END -->
    <!-- Theme styles BEGIN -->
    <link href="<?=base_path;?>theme/assets/global/css/components.css" rel="stylesheet">
    <link href="<?=base_path;?>theme/assets/frontend/onepage/css/style.css" rel="stylesheet">
    <link href="<?=base_path;?>theme/assets/frontend/onepage/css/style-responsive.css" rel="stylesheet">
    <link href="<?=base_path;?>theme/assets/frontend/onepage/css/themes/blue.css" rel="stylesheet" id="style-color">
    <link href="<?=base_path;?>theme/assets/frontend/onepage/css/custom.css" rel="stylesheet">
    <!-- Theme styles END -->
</head>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-2 col-sm-2">
                <a class="scroll site-logo" href="#promo-block"><img src="<?=base_path;?>theme/assets/frontend/onepage/img/logo/red.png" alt="Metronic One Page"></a>
            </div>
            <!-- Logo END -->
        ...
        <div class="tp-banner" >
            <ul>
                <li data-transition="fade" data-slotamount="5" data-masterspeed="700" data-delay="9400" class="slider-item-1">
                    <img src="<?=base_path;?>theme/img/5345864515_037360eaab_b.jpg" alt="" data-bgfit="cover" style="opacity:0.4 !important;" data-bgposition="center center" data-bgrepeat="no-repeat">
                    ...
                    <div class="tp-caption large_bold_white fade"
                         ...
                         style="z-index: 6">CALL53 <span style="color: #DB001C">CUBA</span> Llama a Cuba
                    </div>
                </li>
                <li data-transition="fadefromright" data-slotamount="5" data-masterspeed="700" data-delay="9400" class="slider-item-2">
                    <img src="<?=base_path;?>theme/assets/frontend/onepage/img/silder/Slide2_bg.jpg" alt="slidebg2" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
                    <div class="caption lft start"
                         ...
                         data-speed="600"
                         data-start="500"
                         data-easing="easeOutBack"><img src="<?=base_path;?>theme/assets/frontend/onepage/img/silder/Slide2_iphone_left.png" alt="">
                    </div>
                    <div class="caption lft start"
                         data-y="center"
                         data-voffset="130"
                         ...
                         data-speed="600"
                         data-start="1200"
                         data-easing="easeOutBack"><img src="<?=base_path;?>theme/assets/frontend/onepage/img/silder/Slide2_iphone_right.png" alt="">
                    </div>
                    <div class="tp-caption large_bold_white fade"
                         data-x="center"
                         data-y="40"
                ...
                <li data-transition="fade" data-slotamount="5" data-masterspeed="700" data-delay="9400" class="slider-item-3">
                    ...
                    <div class="tp-caption large_bold_white_25 customin customout tp-resizeme"
                         ...
                         style="z-index: 3">Aplicación para llamar a cuba<br/> a los mejores precios.
                    </div>
...
<div class="about-block content content-center" id="about">
    <div class="container">
        ...
        <div class="ab-trio">
            <img src="<?=base_path;?>theme/assets/frontend/onepage/img/trio.png" alt="" class="img-responsive">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 item">
                <img src="<?=base_path;?>theme/assets/frontend/onepage/img/people/img6-large.jpg" alt="Marcus Doe" class="img-responsive">
                <h3>Marcus Doe</h3>
                <em>Founder</em>
            ...
            <div class="col-md-4 item">
                <img src="<?=base_path;?>theme/assets/frontend/onepage/img/people/img7-large.jpg" alt="Elena Taylor" class="img-responsive">
                <h3>Elena Taylor</h3>
                <em>Designer</em>
                <p>Lorem ipsum dolor amet, tempor ut labore magna tempor dolore</p>
                <div class="tb-socio">
            ...
            <div class="col-md-4 item">
                <img src="<?=base_path;?>theme/assets/frontend/onepage/img/people/img8-large.jpg" alt="Cris Nilson" class="img-responsive">
                <h3>Cris Nilson</h3>
                <em>Developer</em>
                <p>Lorem ipsum dolor amet, tempor ut labore magna tempor dolore</p>
                <div class="tb-socio">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12 text-left">
                <img src="<?=base_path;?>theme/assets/frontend/onepage/img/choose-us.png" alt="Why to choose us" class="img-responsive">
            </div>
            <div class="col-md-6 col-sm-6 col-xs-12 text-left">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-2 col-sm-3 col-xs-6">
                <img src="<?=base_path;?>theme/assets/frontend/onepage/img/partners/cisco.png" alt="cisco">
            </div>
            <div class="col-md-2 col-sm-3 col-xs-6">
                <img src="<?=base_path;?>theme/assets/frontend/onepage/img/partners/walmart.png" alt="walmart">
            </div>
            <div class="col-md-2 col-sm-3 col-xs-6">
                <img src="<?=base_path;?>theme/assets/frontend/onepage/img/partners/gamescast.png" alt="gamescast">
            </div>
            <div class="col-md-2 col-sm-3 col-xs-6">
                <img src="<?=base_path;?>theme/assets/frontend/onepage/img/partners/spinwokrx.png" alt="spinwokrx">
            </div>
            <div class="col-md-2 col-sm-3 col-xs-6">
                <img src="<?=base_path;?>theme/assets/frontend/onepage/img/partners/ngreen.png" alt="ngreen">
            </div>
            <div class="col-md-2 col-sm-3 col-xs-6">
                <img src="<?=base_path;?>theme/assets/frontend/onepage/img/partners/vimeo.png" alt="vimeo">
            </div>
        </div>
    </div>
</div>
...
<!--[if lt IE 9]>
<script src="<?=base_path;?>theme/assets/global/plugins/respond.min.js"></script>
<![endif]-->
<!-- Load JavaScripts at the bottom, because it will reduce page load time -->
<!-- Core plugins BEGIN (For ALL pages) -->
<script src="<?=base_path;?>theme/assets/global/plugins/jquery.min.js" type="text/javascript"></script>
<script src="<?=base_path;?>theme/assets/global/plugins/jquery-migrate.min.js" type="text/javascript"></script>
<script src="<?=base_path;?>theme/assets/global/plugins/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
<!-- Core plugins END (For ALL pages) -->
<!-- BEGIN RevolutionSlider -->
<script src="<?=base_path;?>theme/assets/global/plugins/slider-revolution-slider/rs-plugin/js/jquery.themepunch.revolution.min.js" type="text/javascript"></script>
<script src="<?=base_path;?>theme/assets/global/plugins/slider-revolution-slider/rs-plugin/js/jquery.themepunch.tools.min.js" type="text/javascript"></script>
<script src="<?=base_path;?>theme/assets/frontend/onepage/scripts/revo-ini.js" type="text/javascript"></script>
<!-- END RevolutionSlider -->
<!-- Core plugins BEGIN (required only for current page) -->
<script src="<?=base_path;?>theme/assets/global/plugins/fancybox/source/jquery.fancybox.pack.js" type="text/javascript"></script><!-- pop up -->
<script src="<?=base_path;?>theme/assets/global/plugins/jquery.easing.js"></script>
<script src="<?=base_path;?>theme/assets/global/plugins/jquery.parallax.js"></script>
<script src="<?=base_path;?>theme/assets/global/plugins/jquery.scrollTo.min.js"></script>
<script src="<?=base_path;?>theme/assets/frontend/onepage/scripts/jquery.nav.js"></script>
<!-- Core plugins END (required only for current page) -->
<!-- Global js BEGIN -->
<script src="<?=base_path;?>theme/assets/frontend/onepage/scripts/layout.js" type="text/javascript"></script>
<script>
